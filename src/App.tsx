...
import EmpAdvisory from "./pages/forEmployer/Advisory";
import EmpExecutiveSearch from "./pages/forEmployer/ExecutiveSearch";
import EmpFinance from "./pages/forEmployer/Finance&Accounting";
import EmpGlobalTalent from "./pages/forEmployer/GlobalTalentCenters";
import EmpHiretoRetire from "./pages/forEmployer/HireToRetire";
import EmpHrSupport from "./pages/forEmployer/Hr&Support";
import EmpItes from "./pages/forEmployer/ItesGcc";
import EmpLegal from "./pages/forEmployer/legal&Compliance";
import EmpManagedServices from "./pages/forEmployer/ManagedServices";
import EmpPayroll from "./pages/forEmployer/Payroll";
import EmpPerm from "./pages/forEmployer/PermRecruitement";
import EmpPharma from "./pages/forEmployer/PharmaHealthCare&LifeSciences";
import EmpSalesAndTrade from "./pages/forEmployer/Sales&tradeMarketing";
import EmpTalentAcquisition from "./pages/forEmployer/TalentAcquisition02";
import EmpTalentAcquisition2 from "./pages/forEmployer/TalentAcquisition02";
import EmpTalentDevelopment from "./pages/forEmployer/TalentDevelopment";
import EmpTalentExport from "./pages/forEmployer/TalentExport";
import EmpTalentTransition from "./pages/forEmployer/TalentTransition";
import EmpTempR from "./pages/forEmployer/TempRecruitement";
import EmpWholeSale from "./pages/forEmployer/WholeSale&Retail";
import EmpWorkForceAdv from "./pages/forEmployer/WorkForceAdvisory";
import EmployeeEngg from "./pages/forEmployer/Engineering";
import EmpmanageSolution from "./pages/forEmployer/ManagedSolution";
import EmptalentServices from "./pages/forEmployer/TalentServices";
...
import ForEmpBankingFinance from "./pages/forEmployer/BankingFinanceSales";
import ForEmployeeSupplyChain from "./pages/forEmployer/SupplyChain&Logistics";
...
import ForTalentManufacturingPage from "./pages/forEmployer/Manufacturing";
...
import OurSponserShip from "./pages/aboutUs/OurSponserShip";
...
import ResDiversity from "./pages/Resources/DiversitySeries";
import ResEdi from "./pages/Resources/ed&i";
import ResEmpBranding from "./pages/Resources/EmployerBranding";
import ResEmployerBrand from "./pages/Resources/EmployerBrandSearch";
import ResForEmployer from "./pages/Resources/ForEmployer";
import ResForTalent from "./pages/Resources/ForTalent";
import ResHrTrends from "./pages/Resources/HrTrends";
import ResIndustryInsight from "./pages/Resources/IndustryInsight";
import ResMindMatter from "./pages/Resources/MindMatterSeries";
import ResRandStadInTheNews from "./pages/Resources/RandStadInTheNews";
import ResSalary from "./pages/Resources/SalaryTrends";
import ResStartup from "./pages/Resources/StartupHiring";
import ResTalentInsight from "./pages/Resources/TalentInsight";
import ResTalentPulse from "./pages/Resources/TalentPulseSurvey";
import ResWorkForce from "./pages/Resources/WorkForceManagementArticles";
import ResWorkMonitor from "./pages/Resources/WorkMonitor";
