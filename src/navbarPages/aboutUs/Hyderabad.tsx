            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-[15px] leading-relaxed text-gray-700">
                          Randstad India Private Limited, My<br />
                          Home Twitza, Unit No. 301 and 302,<br />
                          3rd Floor, Raidurg Panmaqtha Village,<br />
                          Serilingampally Mandal, Hyderabad, <br />
                          Hyderabad 500081 TG India
                        </p>
              ...
              <div className="lg:col-span-8 pt-20">
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
                  <p>
                    Hyderabad’s top recruitment agency and employment firm, Randstad helps you land well-paying jobs in dynamic and modern organizations. Wading through the Indian job market means fighting it out with the growing competition. Randstad helps you achieve the alpha by giving you a competitive edge over other candidates. Propelling you to success through focused attention and continuous recruitment support remains our priority to help you experience meaningful employment in your industry. As a leading placement consultant in Hyderabad, we possess the right combination of networks and skill in matching individuals to the right roles. Our job consultancy services include the latest industry insight, targeted job search tips, and ongoing professional support. Looking for the latest jobs in Hyderabad? Browse through Randstad’s latest opportunities and get the job you’ve always wanted.
                  </p>
                </div>
              </div>
            </div>
