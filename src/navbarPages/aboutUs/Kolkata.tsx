...
export default function AboutKolkata() {
  return (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-[15px] leading-relaxed text-gray-700">
                          ...
                          Unimark Asian- 15th Floor, 52/1<br />
                          Shakespeare Sarani, Kolkata Kolkata<br />
                          700017 WB India
                        </p>
              ...
              <div className="lg:col-span-8 pt-20">
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
                  <p>
                    Randstad is the country’s one of the leading placement agencies in Kolkata. With years of experience, Randstad and its consultants are adept at matching the best and skilled talent with the available and most relevant jobs. Kolkata is one of the leading business centres in the country and Randstad recognizes this fact. With various branches in the country and Randstad, a leading recruitment agency, helps qualified individuals find relevant job opportunities in Kolkata. The city of Kolkata provides the highest salary to junior level employees in the country, as per REBR 2017. With this, the focus is on skilled trades, industrial support, banking roles, industrial management roles, etc. Randstad fills these roles in the city with its pool of talented resources. If you are on a job hunt, then look no further. Get in touch with Randstad, a leading job consultancy, today to get noticed by your future employer!
                  </p>
                </div>
              </div>
            </div>
