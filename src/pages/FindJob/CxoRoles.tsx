  ...
  return (
   <>
    <div className="min-h-screen bg-[#F5F5F5] font-sans text-[#141414]">
      ...
      {/* Footer */}
      <footer className="bg-[#0A1A3F] text-white pt-20 pb-10 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 mb-20">
            ...
            <div>
              <h4 className="font-semibold mb-6">for talent</h4>
              <ul className="space-y-4 text-sm text-gray-400">
          ...
          <div className="border-t border-gray-800 pt-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              ...
              <div className="text-xs text-gray-500 max-w-2xl">
                ...
                <div className="flex items-center space-x-2">
                  <div className="text-[#0070AD] font-bold text-xl flex items-center">
                    <svg width="24" height="24" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-1">
                      <path d="M10 10C10 10 15 10 20 15C25 20 25 30 25 30" stroke="#0070AD" strokeWidth="4" strokeLinecap="round"/>
                      <path d="M30 10C30 10 25 10 20 15C15 20 15 30 15 30" stroke="#0070AD" strokeWidth="4" strokeLinecap="round"/>
                    </svg>
                    randstad,
                  </div>
                  <span className="uppercase tracking-widest">human forward and shaping the world of work</span>
                  <span>are registered trademarks of © Randstad N.V.2023</span>
                </div>
              </div>
            </div>

            <div className="mt-12 bg-[#0D214F] p-6 rounded-sm text-xs text-gray-400">
              <p className="mb-4">
                <strong>Security Advice:</strong> Randstad India does not charge any fee at any stage of its recruitment process from the candidate nor allows their employees to collect any fees from any candidates. <span className="text-[#0070AD] cursor-pointer hover:underline">Click here to know more</span>
              </p>
              <p>
                <strong>EEO Statement:</strong> Randstad India is an Equal Employment Opportunity Employer. All qualified applicants receive consideration for employment without regard to race, color, religion, sex, sexual orientation, gender identity or expression, appearance, national origin, age, marital status, veteran status, or disability status, or any other characteristics. Our global mission is to become the world’s most equitable and specialized talent company, and we actively embrace diversity and inclusion as the cornerstones of our success. To read more of Randstad India’s work in the space of equity, diversity and inclusion please <span className="text-[#0070AD] cursor-pointer hover:underline">click here</span>
              </p>
            </div>
