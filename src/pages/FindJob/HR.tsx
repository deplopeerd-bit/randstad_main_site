      ...
      <footer className="bg-[#0a1a3c] text-white pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 mb-20">
            ...
            <div>
              <h4 className="font-medium mb-6">for talents</h4>
              <ul className="space-y-3 text-sm text-gray-400">
          ...
          <div className="border-t border-gray-800 pt-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
              ...
              <div className="text-xs text-gray-500 space-y-4 max-w-3xl">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 mt-12 text-xs text-gray-400">
