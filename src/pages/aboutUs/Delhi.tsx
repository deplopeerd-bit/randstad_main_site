            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-[15px] leading-relaxed text-gray-700">
                          Randstad India Private Limited, Suit<br />
                          No.001 & 002, Ground Floor,  Copia<br />
                          Corporate  Suites, Building No.9, Jasola<br />
                          District Centre, New Delhi New Delhi <br/>
                          110025 DL India
                        </p>
              ...
              <div className="lg:col-span-8 pt-20">
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
                  <p>
                    India’s leading recruitment agency, Randstad aims to enrich job seeking experiences by providing meaningful employment opportunities. With our years of global recruitment experience, we help you navigate the challenging job market in India today. With its premier job consultancy services, Randstad helps you stay ahead of the curve by giving you access to the latest and the best job opportunities in Delhi. Our intricate understanding of recruitment trends, industry insight, and a pool of excellent jobs make us a prime placement consultant in Delhi. We deliver terrific results by matching the right individual for the right job. Stay on top of your game by getting access to the highest-paying jobs in your field, and professional advice every step of your job hunt journey. Start a stellar career journey by browsing through available jobs on our portal.
                  </p>
                </div>
              </div>
            </div>
